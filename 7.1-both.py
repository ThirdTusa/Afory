...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def setupUi(self):
        ...
        self.toolbar.setGeometry(QtCore.QRect(370, 360, 290, 31))
        ...
        self.volume_lab.setGeometry(105, 2, 25, 25)
        self.volume_percentage = QtWidgets.QLabel(self.toolbar)
        self.volume_percentage.setGeometry(140, 2, 50, 25)
        ...
        self.volume_slider.setGeometry(175, 3, 101, 23)
    ...
    def refresh_tracks_display(self):
        ...
        if lost_tracks:
            ...
            dialog.setText("Warning: Lost tracks detected.\n"
                                                    f"Lost tracks:  {lost_tracks}\n"
                                                    f"It means that path to these tracks does not exist.\n"
                                                    f"You can add lost tracks manually by using Add mp3 button.")
...
QComboBox QAbstractItemView::item:selected {
    ...
    def change_bg_color(self):
        ...
        if dialog.exec_():
            ...
            self.settings_win.setStyleSheet(f"""QDialog{{
                                    background-color: {bg_color}
                                    }}""")
            self.cc_win.setStyleSheet(f"""QDialog{{
                                    background-color: {bg_color}
                                    }}""")
            self.save_colors()
