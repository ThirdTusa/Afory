...
class Main(ctk.CTk):
    def __init__(self):
        ...
        self.iconbitmap(resource_path("assets/icons/icon.ico"))
    ...
    def settings_open(self):
        ...
        self.settings_window.iconbitmap(resource_path("assets/icons/icon.ico"))
        ...
        def task():
            try:
                ...
                ydl_opts = {
                    ...
                    'ffmpeg_location': resource_path("assets/ffmpeg/bin/ffmpeg.exe"),
                    'outtmpl': f'C:/Users/{username}/Afory/downloads/%(title)s.%(ext)s',
                    'postprocessors': [{
...
if __name__ == "__main__":
    try:
        ...
        username = simpledialog.askstring("Warning",
                                          f"Program tried to get your username, but failed with error:\n'{e}'\n"
