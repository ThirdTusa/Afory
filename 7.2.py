...
class Popup(QtWidgets.QFrame):
    def __init__(self, font, add_mp3_t, web_download_t):
        super().__init__()

        self.font = font
        self.add_mp3_t = add_mp3_t
        self.web_download_t = web_download_t
    ...
    def funcs(self, t):
        if t == self.add_mp3_t:
            print("add")
            window.add_local_file()
        elif t == self.web_download_t:
            print("download")
...
class AddHoverButton(QtWidgets.QPushButton):
    def enterEvent(self, event):
        print("true")
        window.show_label("add")
        super().enterEvent(event)

    def leaveEvent(self, event):
        print("false")
        window.hide_label("add")
        super().leaveEvent(event)

class ShuffleHoverButton(QtWidgets.QPushButton):
    def enterEvent(self, event):
        print("true")
        window.show_label("shu")
        super().enterEvent(event)

    def leaveEvent(self, event):
        print("false")
        window.hide_label("shu")
        super().leaveEvent(event)

class RepeatHoverButton(QtWidgets.QPushButton):
    def enterEvent(self, event):
        print("true")
        window.show_label("rep")
        super().enterEvent(event)

    def leaveEvent(self, event):
        print("false")
        window.hide_label("rep")
        super().leaveEvent(event)
...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.apply_lang()
        self.popup = Popup(font=self.main_font, add_mp3_t=self.add_mp3, web_download_t=self.download_from_YT)
        self.show()
        if build_os == "Darwin":
            self.setWindowTitle("")
        else:
    ...
    def setupUi(self):
        ...
        self.sidebar.setGeometry(QtCore.QRect(10, 10, 201, 540))
        ...
        self.leftbar.setGeometry(QtCore.QRect(221, 10, 593, 540))
        ...
        self.afory_label.setGeometry(QtCore.QRect(25, 20, 150, 31))
        ...
        self.Tracks_frame.setStyleSheet("""
            background-color: transparent;
            border-radius: 5px;""")
        self.Tracks_frame.setGeometry(QtCore.QRect(230, 70, 571, 280))
        ...
        self.label_current_playlist.setGeometry(QtCore.QRect(230, 30, 571, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(20)
        font.setBold(True)
        ...
        self.toolbar.setGeometry(QtCore.QRect(250, 360, 535, 31))
        self.toolbar.setGraphicsEffect(shadow_t)
        ...
        self.tooltip_label = QtWidgets.QLabel(self.toolbar)
        self.tooltip_label.setGeometry(QtCore.QRect(330, 0, 120, 31))
        self.tooltip_label.setStyleSheet("color: white;")
        self.tooltip_label.setFont(self.main_font)
        self.tooltip_label.setText("")

        self.label_effect = QtWidgets.QGraphicsOpacityEffect(self.tooltip_label)
        self.tooltip_label.setGraphicsEffect(self.label_effect)
        self.label_effect.setOpacity(0)
        self.label_anim = QtCore.QPropertyAnimation(self.label_effect, b"opacity")
        self.label_anim.setDuration(100)

        self.add_mp3_btn = AddHoverButton(self.toolbar)
        self.add_mp3_btn.setGeometry(QtCore.QRect(0, 0, 31, 31))
        self.add_mp3_btn.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.add_mp3_btn.setObjectName("add_mp3_btn")
        self.add_mp3_btn.clicked.connect(lambda: self.show_menu())
        ...
        self.shuffle_btn = ShuffleHoverButton(self.toolbar)
        self.shuffle_btn.setGeometry(QtCore.QRect(35, 0, 31, 31))
        ...
        self.repeat_btn = RepeatHoverButton(self.toolbar)
        self.repeat_btn.setGeometry(QtCore.QRect(70, 0, 31, 31))
        ...
        self.current_track_label.setGeometry(QtCore.QRect(230, 395, 571, 20))
        ...
        self.play_pause_btn.setGeometry(QtCore.QRect(480, 420, 71, 71))
        ...
        self.prev_track_btn.setGeometry(QtCore.QRect(420, 430, 51, 51))
        ...
        self.next_track_btn.setGeometry(QtCore.QRect(560, 430, 51, 51))
        self.next_track_btn.setObjectName("next_track_btn")
        self.next_track_btn.clicked.connect(self.set_next)
        self.volume_lab = QtWidgets.QLabel(self.toolbar)
        self.volume_lab.setGeometry(415, 2, 25, 25)
        self.volume_percentage = QtWidgets.QLabel(self.toolbar)
        self.volume_percentage.setGeometry(445, 2, 50, 25)
        ...
        self.volume_slider = QtWidgets.QSlider(QtCore.Qt.Horizontal, self.toolbar)
        self.volume_slider.setGeometry(480, 3, 40, 23)
        ...
        self.seekbar.setGeometry(250, 500, 535, 5)
        ...
        self.current_track_label_2.setGeometry(QtCore.QRect(230, 520, 571, 20))
    ...
    def setupIcons(self):
        ...
        self.add_playlist_btn.setIconSize(QtCore.QSize(18, 18))
        ...
        self.add_mp3_btn.setIconSize(QtCore.QSize(18, 18))
        self.shuffle_btn.setIcon(QtGui.QIcon(resource_path("assets/icons/shuffle.png")))
        self.shuffle_btn.setIconSize(QtCore.QSize(27, 27))
    ...
    def show_menu(self):
        pos = self.add_mp3_btn.mapToGlobal(
            QtCore.QPoint(
                self.add_mp3_btn.width(),
    ...
    def show_label(self, type):
        if type == "add":
            self.tooltip_label.setText(self.add_mp3)
        elif type == "shu":
            self.tooltip_label.setText(self.shuffle_text)
        elif type == "rep":
            if self.loop:
                self.tooltip_label.setText(self.dont_repeat)
            else:
                self.tooltip_label.setText(self.loop_text)
    ...
    def load_settings(self):
        default_settings = {"volume": 0.7, "font": "Comic Sans MS", "language": "English", "change_volume": True}
    ...
    def refresh_tracks_display(self):
        ...
        for index, path in enumerate(playlist):
            ...
            if os.path.exists(path):
                ...
                buttons_layout.setContentsMargins(120, 0, 0, 0)
    ...
    def set_track_loop(self):
        ...
        self.repeat_btn.setIcon(QtGui.QIcon(resource_path("assets/icons/no-repeat.png")))
        self.tooltip_label.setText(self.dont_repeat)
